...
%description
%{name} aims at providing a clean API and a simple implementation (C++
...
Install the %{name} package if you need a library for simulated seat
availability calculation C++ library.
