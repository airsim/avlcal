#ifndef __AVLCAL_SVC_LOGGER_HPP
#define __AVLCAL_SVC_LOGGER_HPP
...
// /////////////// LOG MACROS /////////////////
#define AVLCAL_LOG_CORE(iLevel, iToBeLogged) \
  { std::ostringstream ostr; ostr << iToBeLogged; \
    AVLCAL::Logger::instance().log (iLevel, __LINE__, __FILE__, ostr.str()); }

#define AVLCAL_LOG_CRITICAL(iToBeLogged) \
  AVLCAL_LOG_CORE (AVLCAL::LOG::CRITICAL, iToBeLogged)

#define AVLCAL_LOG_ERROR(iToBeLogged) \
  AVLCAL_LOG_CORE (AVLCAL::LOG::ERROR, iToBeLogged)

#define AVLCAL_LOG_NOTIFICATION(iToBeLogged) \
  AVLCAL_LOG_CORE (AVLCAL::LOG::NOTIFICATION, iToBeLogged)

#define AVLCAL_LOG_WARNING(iToBeLogged) \
  AVLCAL_LOG_CORE (AVLCAL::LOG::WARNING, iToBeLogged)

#define AVLCAL_LOG_DEBUG(iToBeLogged) \
  AVLCAL_LOG_CORE (AVLCAL::LOG::DEBUG, iToBeLogged)
